    ...
    return (
        <StyledApy>
            <StyledBox className="col-3">
                ...
                <StyledContent>{
                newReward && stakedValue && bscxPrice && stakedValue.usdValue && stakedValue.totalToken2Value && stakedValue.poolWeight ?
                  `${parseFloat(bscxPrice
            ...
            <StyledBox className="col-2">
                ...
                <StyledContent>{newReward ? getBalanceNumber(newReward).toFixed(2) : '~'} JGP</StyledContent>
                <StyledEquility>≈ {stakedValue && newReward && bscxPrice && bscxPrice.times(newReward).div(10 ** 18).div(10 ** 8).toFixed(2)} USD</StyledEquility>
            </StyledBox>
        </StyledApy>
    )
}
