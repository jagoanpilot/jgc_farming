                                ...
                                <BoxItem key={e.id} onClick={() => {
                                    ...
                                    <RowHighLight>
                                        <Col className="col-8 align-center">
                                            <BoxFlex>
                                                <div style={{display: 'flex', marginRight: 10}}>
                                                    <img src={e.icon} alt="JGP" height={30} style={{position: 'relative', zIndex: 2}}/>
                                                    <img src={e.icon2} alt="JGP" height={30} style={{position: 'relative', zIndex: 1, marginLeft: -10}}/>
                                                </div>
                                                <div>
                                                    <TextMedium>
                                                        {e.name}
                                        ...
                                        <Col className="col-4 text-green align-center justify-right">
                                            + {parseFloat(getBalanceNumber(e.pendingReward).toFixed(4)).toLocaleString('en-US')} JGP
                                        </Col>
                                    </RowHighLight>
                                </BoxItem>
                            )}
