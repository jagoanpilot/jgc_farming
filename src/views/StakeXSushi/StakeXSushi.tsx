    ...
    <>
      <StyledFarm>
        ...
        <StyledCardsWrapper>
          <StyledCardWrapper>
          <StyledInfo>
            Users who stake JGP in JGPSafe will receive xJGP LP tokens which represent their proportion of JGP staked. Stakers will need to withdraw their xJGP LP tokens in order to receive their JGP reward.
          </StyledInfo>
          </StyledCardWrapper>
        </StyledCardsWrapper>
      </StyledFarm>
