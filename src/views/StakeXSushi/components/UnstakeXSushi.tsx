...
const UnstakeXSushi: React.FC<HarvestProps> = ({xBSCXTokenAddress}) => {
  ...
  const trackingAPYBalanceXBSCX = useTokenBalanceOf(xBSCXTokenAddress,'0x1babd69449d17a850ed4e1e719c543182f66f1a5');
    ...
    <Card>
      <CardContent>
        <StyledCardContentInner>
          <StyledCardHeader>
            <Label text={`YOUR xJGP`}/>
            <br/>
            <Value value={getBalanceNumber(myXBSCX)}/>
            <Label text={`~ ${xBSCXToBSCX.div(10 ** 18).toFixed(2)} JGP`}/>
          </StyledCardHeader>
