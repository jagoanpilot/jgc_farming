    ...
    <>
      ...
      <StyledFarm>
        ...
        */}
        ...
        <Spacer size="lg" />
        {!isHot &&
          <StyledInfo style={{color: '#ff7e00'}}>
            👉 Every time you stake and unstake LP tokens, the contract will<br/>
            automatically harvest JGP rewards for you!
          </StyledInfo>
        }
        <Spacer size="lg" />
        <StyledCardsWrapper>
          <div>
            ...
            <StyledInfoLP>
              ...
              <div style={{width: 'calc(100% - 70px', color: '#ffffff', fontSize: 16, marginLeft: 20, marginRight: 20}}>
                <div>Add/Remove liquidity to <a style={{color: '#ff7e00', textDecoration: 'none'}} href={pairLink} target="__blank"><b>{symbolShort} pair</b></a> on {protocal} to get <span style={{color: '#ff7e00'}}>{lpToken}</span> tokens. Then deposit those LP tokens on https://jagoanpilot.xyz/farm to receive rewards</div>
                <Spacer size="sm" />
                <a style={{color: '#ff7e00'}} target="__blank" href={addLiquidityLink}>
                  <b>Add Liquidity on {protocal}</b>
                </a>&nbsp;&nbsp;
                <a style={{color: '#ff7e00'}} target="__blank" href={removeLiquidityLink}>
