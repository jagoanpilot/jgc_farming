...
const FarmCard: React.FC<FarmCardProps> = ({ farm }) => {
  ...
  return (
    <StyledCardWrapper>
      {farm.tokenSymbol === 'JGP' && <StyledCardAccent />}
      <Card>
        <CardContent>
          <StyledContent>
            <StyledTopIcon>
            ...
            <StyledInsight>
              ...
              <span>
                {farm.usdValue &&
                  <><b>{parseFloat(farm.usdValue.toFixed(0)).toLocaleString('en-US')} JGP</b></>
            ...
            {farm.isHot && <>
              <StyledInsight>
                ...
                <span>
                  {newReward &&
                    <><b>{getBalanceNumber(newReward).toFixed(2)} JGP</b> / block</>
                  }
                </span>
              </StyledInsight>
              <StyledInsight>
                ...
                <span style={{fontWeight: 'bold', color: '#4caf50'}}>
                  {newReward && farm.poolWeight && farm.bscxPrice && farm.usdValue ?
                    `${parseFloat(farm.bscxPrice
